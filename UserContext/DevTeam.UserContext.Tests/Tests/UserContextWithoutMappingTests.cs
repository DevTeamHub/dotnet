...
[TestClass]
public class UserContextWithoutMappingTests
{
    private static IServiceProvider _serviceProvider = null!;
    private static Home2Controller _controller = null!;
    ...
    public static void Init(TestContext testContext)
    {
        ...
        services.AddScoped<Home2Controller>();

        var mvcBuilder = services.AddControllers();

        mvcBuilder.AddUserContext();
        ...
        _controller = _serviceProvider.GetRequiredService<Home2Controller>();
    ...
    public async Task Shound_Find_Address_Expression_Mapping_In_Storage()
    {
        ...
        Assert.IsNotInstanceOfType<IUserContext<UserModel, int>>(userContext);
    }
}